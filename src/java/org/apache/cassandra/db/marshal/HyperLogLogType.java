...
import org.apache.cassandra.serializers.HyperLogLogSerializer;
...
public class HyperLogLogType<T> extends CollectionType<HyperLogLog<T>>
{
    ...
    public TypeSerializer<HyperLogLog<T>> getSerializer()
    {
        return serializer;
    }
    ...
    public ByteBuffer serialize(List<Pair<ByteBuffer, Column>> columns)
    {
        ...
        //return ByteBuffer.wrap(new String("serialized dadada").getBytes());
